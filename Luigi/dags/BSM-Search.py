...
base_dir = "/home/abd/Desktop/Work/Final_Version/Luigi/data/BSM-Search"
code_dir = '/home/abd/Desktop/Work/Final_Version/Luigi/code/BSM-Search'
...
if __name__ == '__main__':
    #python3 BSM-Search.py --local-schedule --workers 4 --max-task-retries 5 --retry-delay 30
    #------------------------------------ COMBINING START ------------------------------------
